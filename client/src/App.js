...
function App() {
  const baseUrl = "http://CURRENTPiIp:5000/api"; //Set base URL for API calls (Nees to be the IP of the Pi for React frontend to reach the backend/db on the same NGINX server)
